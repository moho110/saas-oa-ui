  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['xinhu-document:wenjuan:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['xinhu-document:wenjuan:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['xinhu-document:wenjuan:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['xinhu-document:wenjuan:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="wenjuanList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="180px">
        ...
        <el-form-item label="针对对象的ID" prop="receid">
        ...
        <el-form-item label="创建人id" prop="optid">
          <el-input v-model="form.optid" placeholder="请输入创建人id" />
        </el-form-item>
        ...
        <el-form-item label="已提交人id" prop="dauserids">
          <el-input v-model="form.dauserids" type="textarea" placeholder="请输入内容" />
        </el-form-item>
...
<script>
import { listWenjuan, getWenjuan, delWenjuan, addWenjuan, updateWenjuan } from "@/api/xinhu-document/wenjuan";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        receid: [
          { required: true, message: "针对对象的ID不能为空", trigger: "blur" }
        ],
        startdt: [
        ...
        dauserids: [
          { required: true, message: "已提交人id不能为空", trigger: "blur" }
        ],
        status: [
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('xinhu-document/wenjuan/export', {
        ...this.queryParams
