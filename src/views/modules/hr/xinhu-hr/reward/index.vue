<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="奖惩对象" prop="object">
        <el-input
      ...
      <el-form-item label="奖惩结果" prop="result">
        <el-input
      ...
      <el-form-item label="发生时间" prop="happendt">
        <el-date-picker clearable size="small"
          v-model="queryParams.happendt"
          type="date"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['xinhu-hr:reward:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['xinhu-hr:reward:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['xinhu-hr:reward:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['xinhu-hr:reward:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="rewardList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="奖惩对象" align="center" prop="object" />
      <el-table-column label="奖惩金额" align="center" prop="money" />
      <el-table-column label="发生地点" align="center" prop="hapaddress" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="180px">
        ...
        <el-form-item label="奖惩对象" prop="object">
          <el-input v-model="form.object" placeholder="请输入奖惩对象" />
        </el-form-item>
        <el-form-item label="对象ID" prop="objectid">
          <el-input v-model="form.objectid" placeholder="请输入对象ID" />
        </el-form-item>
        <el-form-item label="奖惩结果" prop="result">
          <el-input v-model="form.result" placeholder="请输入奖惩结果" />
        </el-form-item>
        <el-form-item label="奖惩金额" prop="money">
          <el-input v-model="form.money" placeholder="请输入奖惩金额" />
        </el-form-item>
        <el-form-item label="发生时间" prop="happendt">
          <el-date-picker clearable size="small"
            v-model="form.happendt"
            type="date"
            value-format="yyyy-MM-dd"
            placeholder="选择发生时间">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="发生地点" prop="hapaddress">
          <el-input v-model="form.hapaddress" placeholder="请输入发生地点" />
        </el-form-item>
...
<script>
import { listReward, getReward, delReward, addReward, updateReward } from "@/api/xinhu-hr/reward";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        object: [
          { required: true, message: "奖惩对象不能为空", trigger: "blur" }
        ],
        objectid: [
          { required: true, message: "对象ID不能为空", trigger: "blur" }
        ],
        type: [
          { required: true, message: "奖惩类型0奖励,1处罚不能为空", trigger: "change" }
        ],
        result: [
          { required: true, message: "奖惩结果不能为空", trigger: "blur" }
        ],
        money: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除奖惩编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('xinhu-hr/reward/export', {
        ...this.queryParams
