<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="报修资产" prop="assetm">
        <el-input
          v-model="queryParams.assetm"
          placeholder="请输入报修资产"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="维修人员" prop="wxname">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['xinhu-police:repair:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['xinhu-police:repair:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['xinhu-police:repair:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['xinhu-police:repair:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="repairList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="报修资产" align="center" prop="assetm" />
      <el-table-column label="维修人员" align="center" prop="wxname" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="180px">
        ...
        <el-form-item label="报修资产" prop="assetm">
          <el-input v-model="form.assetm" placeholder="请输入报修资产" />
        </el-form-item>
        <el-form-item label="保修原因" prop="reason">
          <el-input v-model="form.reason" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="实际原因" prop="reasons">
          <el-input v-model="form.reasons" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="需要外修" prop="iswx">
          <el-radio v-model="form.iswx" label="1">是</el-radio>
          <el-radio v-model="form.iswx" label="0">否</el-radio>
        </el-form-item>
        <el-form-item label="维修金额" prop="money">
          <el-input v-model="form.money" placeholder="请输入维修金额" />
        </el-form-item>
        <el-form-item label="维修人员" prop="wxname">
          <el-input v-model="form.wxname" placeholder="请输入维修人员" />
        </el-form-item>
...
<script>
import { listRepair, getRepair, delRepair, addRepair, updateRepair } from "@/api/xinhu-police/repair";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        assetm: [
          { required: true, message: "报修资产不能为空", trigger: "blur" }
        ],
        reason: [
          { required: true, message: "保修原因不能为空", trigger: "blur" }
        ],
        reasons: [
          { required: true, message: "实际原因不能为空", trigger: "blur" }
        ],
        iswx: [
          { required: true, message: "需要外修不能为空", trigger: "blur" }
        ],
        money: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除维修报修编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('xinhu-police/repair/export', {
        ...this.queryParams
